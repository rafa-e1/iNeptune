...
class TabBarController: UITabBarController {
    ...
    private lazy var mainViewController: UIViewController = {
        ...
        let tabBarItem = UITabBarItem(title: "", image: UIImage(named: ""), tag: 2)
        mainVC.tabBarItem = tabBarItem
        return mainVC
    }()
    ...
    override func viewDidLoad() {
        ...
        view.backgroundColor = #colorLiteral(red: 0.9520556331, green: 0.9570274949, blue: 0.9655476213, alpha: 1)
